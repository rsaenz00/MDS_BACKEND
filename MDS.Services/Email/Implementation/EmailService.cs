...
namespace MDS.Services.Email.Implementation
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendEmailConfirmationAsync(string email, string callbackUrl)
        {
            ...
            using (var mailMessage = new MailMessage())
            {
                ...
                PrepareMailMessage("Confirm your email", $"Please confirm your email by clicking here: <a href='{callbackUrl}'>link</a>", _emailSettings.EmailSourceAddress, email, mailMessage);
        ...
        public async Task SendPasswordResetAsync(string email, string callbackUrl)
        {
            ...
            using (var mailMessage = new MailMessage())
            {
                ...
                PrepareMailMessage("Reset your password", $"Please reset your password by clicking here: <a href='{callbackUrl}'>link</a>", _emailSettings.EmailSourceAddress, email, mailMessage);
